...
sys.path.insert(0, "../../")
from networks.projector import ProjectionV1,ProjectionV3
from networks.sinkhorn import distributed_sinkhorn
import numpy as np
from networks.unetmodel import UNet_DS,UNet2D
...
class UNetProto(nn.Module):
    def __init__(
        ...
        elif self.projection == "v3":
            self.proj_head = ProjectionV3(in_channels, proj_dim)  # mix
    ...
    def warm_up(self,
        ...
        feature2d, classifer2d = self.backbone(x_2d)
        return classifer2d
