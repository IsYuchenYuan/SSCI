...
from networks.DenseNet import dense_rnn_net
...
parser.add_argument('--exp', type=str, default='DenseUNet2d', help='model_name')
...
parser.add_argument('--patchsize', type=list, default=[224,224,12],  help='whether use unlabel data')
